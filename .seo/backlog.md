...
**13 PR ouvertes, aucune fusionnée à ce jour** (dépôt actif depuis le 2026-08-22, soit **17 jours** sans relecture humaine au 2026-09-08 — ce point continue de croître). Répartition par pilier inchangée ce run (aucune nouvelle PR) : pilier 1 = 9/13 (~69 %), pilier 2 = 3/13 (~23 %), pilier 3 = 2/13 (~15 %). Pilier 1 au-dessus de la cible 60 % (effet de la règle de bascule, appliquée faute d'alternative pilier 2 qualifiée), pilier 2 sous la cible 30 %, pilier 3 au-dessus de la cible 10 %. Prochaine session : privilégier un sujet pilier 2 réellement neuf en priorité absolue si le seuil de 14/25 est atteint en veille, pour corriger l'écart qui se creuse légèrement.
